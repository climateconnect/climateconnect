...
LOOKUP_FILE = str(LOOKUP_DIR / "climateconnect_api" / "management" / "commands" / "osm_lookup_tables" / "lookup.csv")
LOOKUP_OSM_ID_FILE = str(LOOKUP_DIR / "climateconnect_api" / "management" / "commands" / "osm_lookup_tables" / "osm_id_lookup.csv")
