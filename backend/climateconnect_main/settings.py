...
EVENT_DELETED_GUEST_NOTIFICATION_TEMPLATE_ID = env(
    "EVENT_DELETED_GUEST_NOTIFICATION_TEMPLATE_ID", ""
)
EVENT_DELETED_GUEST_NOTIFICATION_TEMPLATE_ID_DE = env(
    "EVENT_DELETED_GUEST_NOTIFICATION_TEMPLATE_ID_DE", ""
)
