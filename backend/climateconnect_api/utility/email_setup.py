...
def create_variables_for_weekly_recommendations(language_code: str, project_ids: List = [], organization_ids: List = [], idea_ids: List = []):
    # edit the image and url path for production
    # todo idea has no url 
   
    main_page = {
        "en": "https://climateconnect.earth/en/browse",
        "de": "https://climateconnect.earth/de/browse",
    }
    project_translation = {
        "en": "Project",
        "de": "Projekt",
