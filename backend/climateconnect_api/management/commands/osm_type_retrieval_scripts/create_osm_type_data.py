...
HEADERS = {
    'User-Agent': 'DjangoProjekt/1.0 (katharina.auer@climateconnect.earth)'
}
...
def discover_osm_type(osm_ids: list) -> dict | None:
    ...
    try:
        ...
        if len(ids_with_multiple_possible_types) != 0:
            print(f"WARNING: osm_ids with multiple possible types found: {ids_with_multiple_possible_types}")
