...
if __name__ == "__main__":
    ...
    print("osm_ids_not_in_lookup: ", len(osm_ids_not_in_lookup), [x["name"] for x in osm_ids_not_in_lookup])

    print("missing osm type :", len(missing_osm_type), [x["name"] for x in missing_osm_type])