...
from climateconnect_api.factories import IdeaFactory, OrganizationFactory, OrganizationMemberFactory, ProjectFactory, ProjectLikeFactory, ProjectParentsFactory



def create_project_test_data(number_of_likes = 0, location = None, created_outside_of_timespan = False, has_parent_organization = False):
    ...
    project_parents = ProjectParentsFactory(project=project,)  
