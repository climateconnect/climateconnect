...
class ProjectTypesChoices(models.TextChoices):
  idea = PROJECT_TYPES["idea_type"].type_id_short, _(PROJECT_TYPES["idea_type"].name),
  event = PROJECT_TYPES["event_type"].type_id_short, _(PROJECT_TYPES["event_type"].name),
  project = PROJECT_TYPES["project_type"].type_id_short, _(PROJECT_TYPES["project_type"].name)