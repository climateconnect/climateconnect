...
from organization.models import Project, Organization, Post, Comment
...
class OrganizationTranslation(models.Model):
    ...
    get_involved_translation = models.TextField(
...
class PostTranslation(models.Model):
    ...
    def __str__(self):
        return "{} translation for post id {}".format(self.language.name, self.post.id)
