    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, help_text='Points to post a comment was made to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='organization.Posts', verbose_name='Post')),
            ],
            options={
