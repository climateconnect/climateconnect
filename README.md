...
Note: This is for new Macbook devices. We are currently using node version 14.7.0 in production. Before running `yarn dev`, please run this command `export NODE_OPTIONS=--openssl-legacy-provider`. You can save this in your `~/.zshrc` file as well. 
