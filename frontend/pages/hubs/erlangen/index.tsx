...
interface ErlangenLandingPageProps {
...
const ErlangenLandingPage: FC<ErlangenLandingPageProps> = ({ hubData }) => {
  ...
  return (
    ...
    >
      {locale === "en" ? <EnChErlangenLandingpage /> : <DeChErlangenLandingpage />}
    </DevlinkPage>
  );
};

export default ErlangenLandingPage;
