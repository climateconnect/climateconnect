...
interface EmmendingenLandingPageProps {
...
const EmmendingenLandingPage: FC<EmmendingenLandingPageProps> = ({ hubData }) => {
  ...
  return (
    ...
    >
      {locale === "en" ? <EnChEmmendingenLandingpage /> : <DeChEmmendingenLandingpage />}
    </DevlinkPage>
  );
};

export default EmmendingenLandingPage;
