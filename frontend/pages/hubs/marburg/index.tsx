...
interface MarburgLandingPageProps {
...
const MarburgLandingPage: FC<MarburgLandingPageProps> = ({ hubData }) => {
  ...
  return (
    ...
    >
      {locale === "en" ? <EnChMarburgLandingpage /> : <DeChMarburgLandingpage />}
    </DevlinkPage>
  );
};

export default MarburgLandingPage;
