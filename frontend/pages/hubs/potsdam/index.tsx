...
interface PotsdamLandingPageProps {
...
const PotsdamLandingPage: FC<PotsdamLandingPageProps> = ({ hubData }) => {
  ...
  return (
    ...
    >
      {locale === "en" ? <EnChPotsdamLandingpage /> : <DeChPotsdamLandingpage />}
    </DevlinkPage>
  );
};

export default PotsdamLandingPage;
