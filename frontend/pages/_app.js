...
export default class MyApp extends App {
  constructor(props) {
    ...
    this.signIn = async (token, expiry) => {
      ...
      this.cookies.set("token", token, { path: "/", /*DANGER, JUST A TEST!*/sameSite: "none", expires: new Date(expiry), secure: !["develop", "development", "test"].includes(process.env.ENVIRONMENT) });
