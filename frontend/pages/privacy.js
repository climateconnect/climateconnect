...
export default function Privacy(){
  return (
    <Layout title="Privacy Policy" hideHeadline>
      ...
      <ul>
        <li>Data about the usage of the provided websites (e.g., used browser, used operating system, referrer URL, time of server request, requested contents, duration of usage);</li>
      ...
      We also process your personal data to protect our legitimate interests in line with Article 6 (1), first sentence f) GDPR, except where your interests or fundamental rights and freedoms, which require the protection of your personal data prevail.
      ...
      If you have given us separate consent to process your personal data, we will process your personal data within and on the basis of this consent. Consents may, for example, relate to the registration, or sending of newsletters, in line with Article 6 (1), first sentence a) GDPR.
      Consent is always freely given. Refusing or revoking your consent will not have any negative consequences for you.
      As part of the registration process, the user’s consent to the processing of his data is obtained. User registration is required for the provision of certain contents and services on our website. The registration serves the networking of the users among themselves and the possibility of posting projects and interacting within this context.

      <h2>6. To whom do we transfer your data?</h2>
      We transfer your personal data to the extent necessary for the formation, execution or termination of an agreement or quasi-contractual legal relationship, in principle, within the scope of the processing described below.
      We will share your personal information with the following categories of recipients for the purposes set out above:
      <ul>
      ...
      <h3>9.1 Rights to access, delete, correct, restrict processing, and portability of your data</h3>
      <div>According to Article 15 GDPR, you have the right to obtain confirmation from us as to whether or not personal data concerning you is being processed by us. Where that is the case, you have a right to access the personal data and obtain further information.</div>
      <div>According to Article 16 GDPR, you may have the right to obtain the rectification of inaccurate personal data concerning you without undue delay.</div>
      <div>According to Article 17 GDPR, you may have the right to obtain erasure of personal data concerning you if (i) it is no longer necessary in relation to the purpose for which it is collected, (ii) you have withdrawn your consent on which the processing is based, (iii) you have objected to the processing pursuant to Article 21 (1) GDPR and there are no overriding legitimate grounds for the processing, or the data subject objects to the processing pursuant to Article 21 (2) GDPR, (iv) your personal data has been unlawfully processed; (v) the personal data has to be erased for compliance with a legal obligation to which Climate Connect is subject , or (vi) the personal data has been collected in relation to the offer of information society services pursuant to Article 8 (1) GDPR.</div>
      <div>According to Article 18 GDPR, you may have the right to obtain the restriction of processing. Such right shall exist if (i) you contested the accuracy of the personal data, (ii) the processing is unlawful and you oppose the erasure of the personal data and request the restriction of its use instead, (iii) the personal data is no longer needed for the purposes of the processing, but it is required by you for the establishment, exercise or defense of legal claims, or (iv) you have objected to processing pursuant to Article 21(1) GDPR pending the verification of whether our grounds legitimately override yours.</div>
      <div>According to Article 19 GDPR, you have the right to obtain information about the recipients of data to whom the rectification, erasure, or restriction of processing has been communicated.</div>
      <div>According to Article 20 GDPR, you have the right to obtain personal data concerning you in a structured, commonly used and machine-readable format and to transmit the data to another controller.</div>
      <div>If the processing or transfer of your personal data is based on a consent given by you, you can withdraw your consent at any time with effect for the future.</div>
      <div>You have the right to lodge a complaint against the processing of your data or any decision of Climate Connect in relation to one of your rights you have exercised, to the supervisory authority at your place of business or the Bavarian State Office for Data Protection Supervision (Bayerisches Landesamt für Datenschutzaufsicht (BayLDA)), Promenade 18, 91522 Ansbach.</div>
      ...
      We use the open source software tool Matomo (former PIWIK) on our website to analyze the surfing behavior of our users. If individual pages of our website are called up, the following data are stored:
      <br/>
      <div>(1) Two bytes of the IP address of the calling system of the user</div>
      <div>(2) The website called up</div>
      <div>(3) The website from which the user accessed the website (referrer)</div>
      <div>(4) the sub-pages that are called up from the called up website</div>
      <div>(5) The time spent on the website</div>
      <div>(6) The frequency of accessing the website</div>
      <br/>
      The software runs exclusively on the servers of our website. A storage of personal data of the users only takes place there. The data will not be passed on to third parties. You can prevent the use of cookies by making the appropriate settings in your browser, but we would like to point out that in this case you may not be able to use all functions of this website to their full extent. You can
      find more information about the privacy setting of the Matomo software under
      the following link: https://matomo.org/docs/privacy/.
      ...
      Cookies are stored on the user’s computer and transmitted by the user to our site. Therefore you have full control over the use of cookies. By changing the settings in your internet browser, you can deactivate or restrict the transmission of cookies. Cookies, which have already been stored, can be deleted at any time. This can also be done automatically.
      ...
      If you do not agree with the storage and evaluation of these data from your visit, you can object to the storage and use of these data at any time by using the banner that that appears when twingle is used.

      On our internet pages we use external provide fonts, Google fonts. Google Fonts is a service of Google Inc. (“Google”). The integration of these fonts is done by a server call, usually a Google server in the USA. This transfers to the server which of our internet pages you have visited. The IP address of the browser of the end device of the visitor is also stored by Google. You will find more detailed information in the Google data protection information, which you can access here:
      <div>https://fonts.google.com/about</div>
      <div>https://policies.google.com/privacy</div>

      On our internet pages we use the services of the video portal YouTube LLC, 901 Cherry Ave., 94066 San Bruno, CA, USA, (“YouTube”) for the integration of videos. In connection with the provision of YouTube, we use the “Extended Privacy Mode” which is intended to ensure that data is only transferred to YouTube when the videos are accessed.
      ...
      Further information on the collection and use of data and your rights and protection options in this regard is provided by Google in the data protection information available at:
      Link

      On our internet pages we use the services of the cloud communications platform Twilio Inc., 375 Beale Street, Suite 300, San Francisco, CA 94105 for sending automatic emails.
      Link
