...
import _styles from "./DeChPotsdamLandingpage.module.css";
...
export function DeChPotsdamLandingpage({ as: _Component = _Builtin.Block }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "ch-potsdam-landingpage")}
      tag="div"
    >
      <_Builtin.Section
      ...
      >
        ...
        >
          ...
          >
            <_Builtin.Heading
              className={_utils.cx(_styles, "heading-117")}
              tag="h1"
            >
              <_Builtin.Span
                className={_utils.cx(_styles, "text-span-22-copy")}
        ...
        />
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-152-copy")}
          tag="div"
        >
          <_Builtin.Image
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Paragraph>
                {
                  "Im ClimateHub kommen alle Klimaaktiven in Potsdam zusammen. Ob Projekte die erst noch starten, alt eingesessene Organisationen oder Events zum einfach mal vorbei schauen. Für jeden ist etwas dabei. Probiere es aus und mach mit!"
                }
              </_Builtin.Paragraph>
            </_Builtin.Block>
            <_Builtin.Block
      ...
      >
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "div-block-154")}
            tag="div"
          >
            <_Builtin.Heading
              className={_utils.cx(_styles, "heading-116")}
              tag="h1"
            >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "div-block-156")}
              tag="div"
            >
              <_Builtin.Block
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-177")}
                tag="div"
              >
                <_Builtin.Image
                  loading="lazy"
        ...
        >
          ...
          >
            <_Builtin.Block tag="div">
              ...
              <_Builtin.Paragraph>
                {
                  "Ob du aktiv werden möchtest, Verbündete für deine Idee suchst oder eine Frage zum Klimaschutz in Potsdam hast - Bene ist der Klimavernetzer des ClimateHub Potsdam und hilft dir gerne weiter. "
                }
                <br />
                {
                  "Bene ist mit allen ClimateHub-Mitgliedern in Kontakt, vernetzt die lokalen Initiativen und stößt neue wirkungsvolle Klimaprojekte an. Falls du also auf dem ClimateHub nicht das findest, was du benötigst, kannst du dich jederzeit bei ihm melden und er hilft dir weiter."
                }
                <br />
              </_Builtin.Paragraph>
            </_Builtin.Block>
            ...
            >
              ...
              >
                {
                  '"Lasst uns Klimaschutz in Potsdam zur Gemeinschaftsaufgabe machen!"'
                }
              </_Builtin.Block>
              <_Builtin.Link
                className={_utils.cx(_styles, "button-on-main-color")}
        ...
        >
          ...
          >
            ...
            >
              ...
              <_Builtin.Paragraph>
                {
                  "Der ClimateHub ist ein gemeinnütziger Anlaufpunkt für alle Menschen die sich in Potsdam für Klimaschutz einsetzten und die die Lust haben sich zu engagieren. Es gibt eine eigene Online-Plattform als digitale Austauschmöglichkeit und unseren lokalen Vernetzer Bene vor Ort. Gemeinsam bringen wir alle Akteur*innen der Stadt zusammen, um gemeinsam die Klimakrise zu bekämpfen. Mit vielen Events und Aktionen begeistern wir noch mehr Menschen für ein Klimaschutz Engagement."
                }
              </_Builtin.Paragraph>
            </_Builtin.Block>
            <_Builtin.Block
            ...
            >
              <_Builtin.DropdownWrapper
                ...
                data-w-id="fd2efba1-73c9-c87b-3b64-8f3f11315142"
                tag="div"
                delay={0}
                hover={false}
              >
                ...
                >
                  ...
                  >
                    {
                      "Die Plattform vereint alle Gruppen aus Potsdam und macht sie so leicht auffindbar. Sie ist zentraler Austauschort für Interessierte und Aktive."
                    }
                  </_Builtin.Paragraph>
                  <_Builtin.Link
                    className={_utils.cx(_styles, "button-in-main-color")}
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="fd2efba1-73c9-c87b-3b64-8f3f1131514d"
                tag="div"
                delay={0}
                hover={false}
              >
                ...
                >
                  ...
                  >
                    {
                      "Hier findest du bevorstehende Veranstaltungen in Potsdam. Der Kalender wird von Bene betreut und die Events über unsere Email und Social Media Kanäle regelmäßig beworben."
                    }
                  </_Builtin.Paragraph>
                </_Builtin.DropdownList>
              </_Builtin.DropdownWrapper>
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="fd2efba1-73c9-c87b-3b64-8f3f11315156"
                tag="div"
                delay={0}
                hover={false}
              >
                ...
                >
                  ...
                  <_Builtin.Link
                    ...
                    block=""
                    options={{
                      href: "https://climateconnect.earth/de/climatematch?from_hub=potsdam",
                      target: "_blank",
                    }}
                  >
                    {"jetzt machen"}
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="fd2efba1-73c9-c87b-3b64-8f3f11315161"
                tag="div"
                delay={0}
                hover={false}
              >
                ...
                >
                  ...
                  >
                    {
                      "Hast du eine Ideen und suchst Unterstützung um diese Umzusetzen? Stell deine Klimaschutz-Idee ein und finde passenden Mitstreiter*innen."
                    }
                  </_Builtin.Paragraph>
                  <_Builtin.Link
                    className={_utils.cx(_styles, "button-in-main-color")}
                    ...
                    block=""
                    options={{
                      href: "https://climateconnect.earth/de/share",
                      target: "_blank",
                    }}
                  >
                    {"Idee Teilen"}
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="fd2efba1-73c9-c87b-3b64-8f3f1131516c"
                tag="div"
                delay={0}
                hover={false}
              >
                ...
                >
                  ...
                  >
                    {
                      "Über den Climate Connect chat erreichst du alle Klimaakiven aus deiner Stadt. schreibe eine nachricht wenn du gerne mitmachen möchstest oder eine Frage hast."
                    }
                  </_Builtin.Paragraph>
                </_Builtin.DropdownList>
              </_Builtin.DropdownWrapper>
        ...
        >
          <_Builtin.Block tag="div">
            <_Builtin.Block tag="div">
              ...
              <_Builtin.Paragraph>
                {
                  "Im ClimateHub findest du alle aktiven Klimagruppen in Potsdam"
                }
              </_Builtin.Paragraph>
              <_Builtin.SliderWrapper
            ...
            >
              ...
              >
                ...
                >
                  {
                    "Wir sind Fridays for Future Potsdam.Es gibt ein Wöchentliches Plenum, welches abwechselnd Montag oder Dienstag im Madia in der Innenstadt stattfindet."
                  }
                </_Builtin.Paragraph>
                <_Builtin.Block
                  className={_utils.cx(_styles, "div-block-158")}
              ...
              >
                ...
                >
                  {
                    "Brandenburg 21 setzt sich landesweit für die Umsetzung der Agenda 2030 einsetzt. Unsere Arbeitsschwerpunkte sind nachhaltige Kommunal- und Regionalentwicklung, BNE und nachhaltiges Wirtschaften."
                  }
                </_Builtin.Paragraph>
                <_Builtin.Block
                  className={_utils.cx(_styles, "div-block-158")}
              ...
              >
                ...
                >
                  {
                    "Wir sind das Bürgerbegehren für Potsdams Energiewende. Unser Ziel: Eine bezahlbare, nachhaltige und klimafreundliche Energieversorgung für Alle. Die Unterschriftensammlung läuft: 14.500 Unterschriften bis September 2023!"
                  }
                </_Builtin.Paragraph>
                <_Builtin.Block
                  className={_utils.cx(_styles, "div-block-158")}
      ...
      >
        ...
        >
          ...
          <_Builtin.Paragraph className={_utils.cx(_styles, "paragraph-141")}>
            {
              "Die Mitglieder des ClimateHubs bringen ihr zum Leben und unsere institutionellen Partner machen den ClimateHub erst möglich. "
            }
          </_Builtin.Paragraph>
          <_Builtin.Block
            className={_utils.cx(_styles, "div-block-206")}
            tag="div"
          >
            <_Builtin.Image
              loading="lazy"
        ...
        >
          ...
          >
            <_Builtin.Heading
              ...
              tag="h1"
            >
              {"Jetzt Mitglied werden und deinen ClimateHub unterstützen"}
            </_Builtin.Heading>
            <_Builtin.Paragraph className={_utils.cx(_styles, "paragraph-124")}>
              {
                "Schon ab 2€ im Monat kannst du dazu beitragen, dass der ClimateHub langfristig einen Unterschied machen kann. Der Climate Connect Deutschland e.V. unterstützt mit deiner Mitgliedschatf deinen ClimateHub."
              }
            </_Builtin.Paragraph>
            <_Builtin.Block
            ...
            >
              ...
              >
                <_Builtin.Block
                  ...
                  tag="div"
                >
                  {"Den Climate Connect Deutschland e.V. unterstützen:"}
                </_Builtin.Block>
                <_Builtin.Link
                  className={_utils.cx(
                    _styles,
