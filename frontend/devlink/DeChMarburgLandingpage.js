...
import _styles from "./DeChMarburgLandingpage.module.css";
...
export function DeChMarburgLandingpage({ as: _Component = _Builtin.Block }) {
          ...
          >
            ...
            >
              <_Builtin.Link
                ...
                block=""
                options={{
                  href: "https://climateconnect.earth/de/hubs/marburg",
                }}
              >
                {"zum ClimateHub"}
              </_Builtin.Link>
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Paragraph>
                {
                  "Im ClimateHub kommen alle Klimaaktiven in Marburg zusammen. Ob Projekte die erst noch starten, alt eingesessene Organisationen oder Events zum einfach mal vorbei schauen. Für jeden ist etwas dabei. Probiere es aus und mach mit!"
                }
              </_Builtin.Paragraph>
            </_Builtin.Block>
            <_Builtin.Block
            ...
            >
              ...
              >
                ...
                <_Builtin.SliderArrow dir="left">
                  <_Builtin.Icon
                    className={_utils.cx(_styles, "icon-12")}
                    widget={{
                      type: "icon",
                      icon: "slider-left",
                    }}
                ...
                <_Builtin.SliderArrow dir="right">
                  <_Builtin.Icon
                    className={_utils.cx(_styles, "icon-13")}
                    widget={{
                      type: "icon",
                      icon: "slider-right",
                    }}
        ...
        >
          ...
          >
            <_Builtin.Block tag="div">
              ...
              <_Builtin.Paragraph>
                {
                  "Ob du aktiv werden möchtest, Verbündete für deine Idee suchst oder eine Frage zum Klimaschutz in Marburg hast - Stefan ist der Klimavernetzer des ClimateHub Marburg und hilft dir gerne weiter. "
                }
                <br />
                {
                  "Stefan ist mit allen ClimateHub-Mitgliedern in Kontakt, vernetzt die lokalen Initiativen und ermöglicht ganz aktiv neue wirkungsvolle Klimaprojekte. Falls du also auf dem ClimateHub nicht das findest, was du suchst, kannst du dich jederzeit bei ihm melden und er hilft dir weiter."
                }
                <br />
              </_Builtin.Paragraph>
            </_Builtin.Block>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {"Zum ClimateHub Marburg"}
                  </_Builtin.Link>
                </_Builtin.DropdownList>
              </_Builtin.DropdownWrapper>
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="9e9ef8bb-7616-7852-6364-2fbe948cbc46"
                tag="div"
                delay={0}
                hover={false}
              >
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="9e9ef8bb-7616-7852-6364-2fbe948cbc4f"
                tag="div"
                delay={0}
                hover={false}
              >
                ...
                >
                  ...
                  <_Builtin.Link
                    ...
                    block=""
                    options={{
                      href: "https://climateconnect.earth/de/climatematch?from_hub=marburg",
                    }}
                  >
                    {"jetzt machen"}
                  </_Builtin.Link>
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="9e9ef8bb-7616-7852-6364-2fbe948cbc5a"
                tag="div"
                delay={0}
                hover={false}
              >
              ...
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "accordeon-ch")}
                data-w-id="9e9ef8bb-7616-7852-6364-2fbe948cbc65"
                tag="div"
                delay={0}
                hover={false}
              >
        ...
        >
          ...
          >
            ...
            <_Builtin.Paragraph className={_utils.cx(_styles, "paragraph-154")}>
              {
                "Wir halten alle ClimateHub Mitglieder regelmäßig auf dem laufenden mit unserem monatlichen Newsletter. Anstehende Events, Projekte zum Mitmachen oder Neuerungen auf der Plattform. Melde dich einfach auf dem ClimateHub an oder du schaust dir erstmal unsere vergangenen Newsletter an. "
              }
            </_Builtin.Paragraph>
            <_Builtin.Link
              className={_utils.cx(_styles, "button-on-main-color")}
