  ...
  return (
    <div className={classes.root}>
      ...
      <TextLoop mask={true} interval={3000}>
        ...
        <Typography className={classes.text}>{texts.saving_your_idea_in_our_database}...</Typography>
        <Typography className={classes.text}>{texts.preparing_your_idea_to_be_published}...</Typography>
