  ...
  return (
    <div>
      <Layout title="Imprint/Legal Disclosure">
        ...
        Represented by
        <br />
        Christoph Stoll, Tobias Rehm, Thomas Bove
        <br />
        <br />
        <h2>Contact Information</h2>
        Telephone: +4915730101056
        <br />
        E-Mail: <a href="mailto:contact@climateconnect.earth">contact@climateconnect.earth</a>
        <br />
        Internet address:{" "}
        ...
        <br />
        <h2>Disclaimer</h2>
        Consumer dispute settlement / universal arbitration body
        <br />
        ...
        by this as per &sect;&sect; 8 to 10 of the Telemedia Act (TMG).
        <br />
        <br />
        ...
        expressly permitted by law, every form of utilizing, reproducing or processing works subject
        to copyright protection on our web pages requires the prior consent of the respective owner
