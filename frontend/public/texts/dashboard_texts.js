export default function getDashboardTexts({ user, location }) {
  return {
    ...
    welcome_message_logged_in: {
      ...
      de: `Schön, dass du da bist, ${user?.first_name}! Teile dein Klimaschutzprojekt mit Community aus ${location?.city}!`,
    },
    welcome_message_logged_out: {
      ...
      de:
        `Schön, dass du da bist! Hier siehst du, was in ${location?.city} das Klima getan wird und kannst mitmachen!`,
    },
    create_idea: {
      en: "Create Idea",
      de: "Idee erstellen",
