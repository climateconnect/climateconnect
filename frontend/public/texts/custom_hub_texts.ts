...
const perth_texts = {
  ...
  climatecafe_welcometext: {
    en:
      `Climate Café®: Supported by the global Climate Café® Network team, the Perth & Kinross network has been growing since 2015 with community led Climate Café® spaces to ‘drink, chat and act’ across the region.
